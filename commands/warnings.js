...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (sub === 'servidor') {
      // Mantém público com Components V2, como você já faz
      ...
      // Efêmero com toast; sem DM para o usuário
      try {
      ...
      await toast(interaction, `<:ActionCheck:1411491648516522104> Todos os warnings de ${user.tag} foram removidos.`);
      ...
      // Mantém fluxo com Components V2 e confirmação inline pública
